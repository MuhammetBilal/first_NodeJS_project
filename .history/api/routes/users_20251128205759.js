...
router.post("/auth", async (req,res) => {
  try {
    ...
    if(!user) throw new CustomError(Enum.HTTP_CODES.UNAUTHORIZED,i18n.translate("COMMON.VALIDATION_ERROR_TITLE",config.DEFAULT_LANG),i18n.translate("USERS.AUTH_ERROR",config.DEFAULT_LAN )); // kullanıcı kontrolü yapıldı kullanıcı bulundu

    if(!user.validPassword) throw new CustomError(Enum.HTTP_CODES.UNAUTHORIZED,i18n.translate("COMMON.VALIDATION_ERROR_TITLE",config.DEFAULT_LAN),i18n.translate("USERS.AUTH_ERROR",config.DEFAULT_LAN)); 
